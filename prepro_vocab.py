...
def main(params):
    train_info_json=json.load(open(params['train_input_json'], 'r'))
    test_info_json = json.load(open(params['test_input_json'], 'r'))
    videos = train_info_json['sentences'] + test_info_json['sentences']
    video_caption = {}
    for i in videos:
    ...
    videos = train_info_json['videos'] + test_info_json['videos']
    for i in videos:
        if i['split'] == 'validate':
...
if __name__ == "__main__":
    ...
    # input json
    parser.add_argument('--train_input_json', type=str, default='data/train-video-annotation/train_val_videodatainfo.json',
                        help='msr_vtt train videoinfo json')
    parser.add_argument('--test_input_json', type=str, default='data/test-video-annotation/test_videodatainfo.json',
                        help='msr_vtt test videoinfo json')
